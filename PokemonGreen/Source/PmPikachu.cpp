...
namespace game_framework {
	...
	PmPikachu::PmPikachu(PmType pmtype)
	{
		...
		skillTree.insert(pair<int, Skill*>(8, skFactory.CreateSkill(thundershock, pmtype)));
		skillTree.insert(pair<int, Skill*>(15, skFactory.CreateSkill(thunderbolt, pmtype)));
		Init("pikachu");
	}
